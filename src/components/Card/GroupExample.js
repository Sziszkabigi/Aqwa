  ...
  return (
    <div className={classes.container}>
      <CardGroup>
        ...
        <Card.Title className={classes.title_top}>{text[0].title[0]}</Card.Title>
        <Card.Title className={classes.title}>{text[0].title[1]}</Card.Title>
          <Card.Img  className={classes.card_image} variant="top" src={sevricesImage1} />
          <Card.Body>
            <Card.Text className={classes.text}>{text[0].description}</Card.Text>
          </Card.Body>
          {/* <Card.Footer>
        ...
        <Card className={classes.card}>
        <Card.Title className={classes.title_top}>{text[1].title[0]}</Card.Title>
        <Card.Title className={classes.title}>{text[1].title[1]}</Card.Title>
          <Card.Img className={classes.card_image} variant="top" src={sevricesImage2}  />
          <Card.Body>
            <Card.Text className={classes.text}>{text[1].description}</Card.Text>
          </Card.Body>
        </Card>
        <Card className={classes.card}>
        <Card.Title className={classes.title_top}>{text[2].title[0]}</Card.Title>
        <Card.Title className={classes.title}>{text[2].title[1]}</Card.Title>
          <Card.Img className={classes.card_image} variant="top" src={sevricesImage3}  />
          <Card.Body>
            <Card.Text className={classes.text}>{text[2].description}</Card.Text>
          </Card.Body>
        </Card>
      </CardGroup>
      <span id="sec_1"></span>
